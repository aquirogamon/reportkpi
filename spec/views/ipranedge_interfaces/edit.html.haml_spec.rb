...
RSpec.describe "ipranedge_interfaces/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit ipranedge_interface form" do
    render

    assert_select "form[action=?][method=?]", ipranedge_interface_path(@ipranedge_interface), "post" do
