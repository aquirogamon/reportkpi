...
RSpec.describe "internet_links/new", type: :view do
  before(:each) do
    assign(:internet_link, InternetLink.new(
      :iru => "MyString",
      :tierone => "MyString",
  ...
  it "renders new internet_link form" do
    render

    assert_select "form[action=?][method=?]", internet_links_path, "post" do
