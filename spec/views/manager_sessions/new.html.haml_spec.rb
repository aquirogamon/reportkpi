...
RSpec.describe "manager_sessions/new", type: :view do
  before(:each) do
    assign(:manager_session, ManagerSession.new(
  ...
  it "renders new manager_session form" do
    render

    assert_select "form[action=?][method=?]", manager_sessions_path, "post" do
