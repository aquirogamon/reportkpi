...
RSpec.describe "internet_interfaces/new", type: :view do
  before(:each) do
    assign(:internet_interface, InternetInterface.new(
      :device => "MyString",
      :port => "MyString",
      :servicio => "MyString",
      :gbpsrx => 1.5,
  ...
  it "renders new internet_interface form" do
    render

    assert_select "form[action=?][method=?]", internet_interfaces_path, "post" do
